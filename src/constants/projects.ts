const projects = [
  {
    id: "1",
    title: 'grabbr',
    image: '/images/blog/grabbr.png',
    description: 'A lightweight data fetching utility for JavaScript that includes automatic caching, time based revalidation and more.',
    href: 'https://www.npmjs.com/package/grabbr',
    longDescription: 'A small data fetching utility for JavaScript that includes automatic caching, time based revalidation, support for SSR and React Query. '
  },
  {
    id: "2",
    title: 'signal-server.io',
    image: '/images/blog/signalserver.png',
    description: 'A custom signaling server for implementing WebRTC applications',
    href: 'https://www.npmjs.com/package/signal-server.io',
    longDescription: 'A custom signaling server designed for WebRTC implementations. The server is built with node.js and WebSockets'
  },
    {
      id: "3",
